# Interface: Y_BCA1234_READ_ROLE_RFC | Richtung: incoming | Typ: RFC | System: SAP-External-Systems | Dateien: src/upd/ybca1234_role_bk.fugr/y_bca1234_read_role_rfc.abap | Kurz: Ermöglicht externen Systemen das Lesen von Rollen-Informationen aus dem ZBV-System

Modus: agent
Arbeitsbereich: @workspace

Analysiere die oben genannte Schnittstelle im Codebestand von `@workspace`. Gib eine kurze Dokumentationszeile mit:
