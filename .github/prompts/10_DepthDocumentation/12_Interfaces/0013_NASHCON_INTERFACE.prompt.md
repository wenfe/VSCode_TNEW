# Interface: NASHCON_INTERFACE | Richtung: bidirectional | Typ: Custom Interface | System: NASHCON-External | Dateien: src/nash/package.devc.xml | Kurz: Externe Nashcon Benutzerverwaltung (Implementierung nicht im Workspace sichtbar)
