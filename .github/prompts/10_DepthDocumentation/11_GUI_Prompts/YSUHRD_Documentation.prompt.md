# GUI-Dokumentation: YSUHRD - User data from HR

**Transaktion:** YSUHRD  
**Programm:** YBCA1234_HRD010  
**Komponente:** HR User Management (hr)  
**Typ:** Report
...
Erstelle eine vollstÃ¤ndige GUI-Dokumentation fÃ¼r die Transaktion **YSUHRD** mit detaillierten UI-Mockups, Funktionsbeschreibungen und Ablaufdiagrammen.
...
- Hauptprogramm: `#file:../../../../src/hr/ybca1234_hrd010.prog.abap`
- TOP-Include: `#file:../../../../src/hr/ybca1234_hrd010_top.prog.abap` (falls vorhanden)
- Form-Routinen: Suche nach `ybca1234_hrd010_f*.prog.abap`
...
```mermaid
flowchart TD
    Start([Start YSUHRD]) --> Selection[Screen anzeigen]
...
FÃ¼ge Verlinkung in `#file:../../../../docs/03_ComponentDocumentation/6.01_HRUserManagementDocumentation.md` ein:

ErgÃ¤nze im Abschnitt "GUI-Transaktionen":

```markdown
#### YSUHRD - User data from HR

**Typ:** Report  
**Hauptprogramm:** `YBCA1234_HRD010`

**Zweck:** [Kurzbeschreibung basierend auf Analyse]

**Detaillierte Dokumentation:** [GUI-Mockup YSUHRD](./../../../.github/prompts/3_DepthDocumentation/11_GUI_Prompts/YSUHRD_Mockup.md)
...
Ã„ndere Status von â³ zu âœ… fÃ¼r YSUHRD.
