# GUI-Dokumentation: YROLEBK_01 - Ref. f?r alle Berechtigungskoordin.
...
Erstelle eine vollstÃ¤ndige GUI-Dokumentation fÃ¼r die Transaktion **YROLEBK_01** mit detaillierten UI-Mockups, Funktionsbeschreibungen und Ablaufdiagrammen.
...
- Hauptprogramm: `#file:../../../../src/upd/ybca1234_bk_ref_01.prog.abap`
- TOP-Include: `#file:../../../../src/upd/ybca1234_bk_ref_01_top.prog.abap` (falls vorhanden)
- Form-Routinen: Suche nach `ybca1234_bk_ref_01_f*.prog.abap`
...
Erstelle ein detailliertes ASCII-Art Mockup.
...
```mermaid
flowchart TD
    Start([Start YROLEBK_01]) --> Selection[Screen anzeigen]
...
```markdown
#### YROLEBK_01 - Ref. f?r alle Berechtigungskoordin.

**Typ:** Report  
**Hauptprogramm:** `YBCA1234_BK_REF_01`

**Zweck:** [Kurzbeschreibung basierend auf Analyse]

**Detaillierte Dokumentation:** [GUI-Mockup YROLEBK_01](./../../../.github/prompts/3_DepthDocumentation/11_GUI_Prompts/YROLEBK_01_Mockup.md)
...
Ã„ndere Status von â³ zu âœ… fÃ¼r YROLEBK_01.
