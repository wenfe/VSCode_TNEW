# GUI-Dokumentation: Y1626XT_DBSE16N_DATA - SE16N ?nderungsbelege Anzeigen

**Transaktion:** Y1626XT_DBSE16N_DATA  
**Programm:** RKSE16N_CD_DISPLAY  
...
Erstelle eine vollstÃ¤ndige GUI-Dokumentation fÃ¼r die Transaktion **Y1626XT_DBSE16N_DATA** mit detaillierten UI-Mockups, Funktionsbeschreibungen und Ablaufdiagrammen.
...
- Hauptprogramm: `#file:../../../../src/adm/rkse16n_cd_display.prog.abap`
- TOP-Include: `#file:../../../../src/adm/rkse16n_cd_display_top.prog.abap` (falls vorhanden)
- Form-Routinen: Suche nach `rkse16n_cd_display_f*.prog.abap`
...
â”‚ Y1626XT_DBSE16N_DATA - SE16N ?nderungsbelege Anzeigen                                         âŠ  â–¡ Ã—  â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
...
```mermaid
flowchart TD
    Start([Start Y1626XT_DBSE16N_DATA]) --> Selection[Screen anzeigen]
...
```markdown
#### Y1626XT_DBSE16N_DATA - SE16N ?nderungsbelege Anzeigen

**Typ:** Report  
**Hauptprogramm:** `RKSE16N_CD_DISPLAY`

**Zweck:** [Kurzbeschreibung basierend auf Analyse]

**Detaillierte Dokumentation:** [GUI-Mockup Y1626XT_DBSE16N_DATA](./../../../.github/prompts/3_DepthDocumentation/11_GUI_Prompts/Y1626XT_DBSE16N_DATA_Mockup.md)
...
Ã„ndere Status von â³ zu âœ… fÃ¼r Y1626XT_DBSE16N_DATA.
...
1. **GUI-Mockup-Dokumentation:**
   `#newfile:Y1626XT_DBSE16N_DATA_Mockup.md`
