# GUI-Dokumentation: YAUDN - Auslesen des Audit-Log (Standard)

**Transaktion:** YAUDN  
**Programm:** RSAU_SELECT_EVENTS  
...
Erstelle eine vollstÃ¤ndige GUI-Dokumentation fÃ¼r die Transaktion **YAUDN** mit detaillierten UI-Mockups, Funktionsbeschreibungen und Ablaufdiagrammen.
...
- Hauptprogramm: `#file:../../../../src/adm/rsau_select_events.prog.abap`
- TOP-Include: `#file:../../../../src/adm/rsau_select_events_top.prog.abap` (falls vorhanden)
- Form-Routinen: Suche nach `rsau_select_events_f*.prog.abap`
...
â”‚ YAUDN - Auslesen des Audit-Log (Standard)                                         âŠ  â–¡ Ã—  â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
...
```mermaid
flowchart TD
    Start([Start YAUDN]) --> Selection[Screen anzeigen]
...
```markdown
#### YAUDN - Auslesen des Audit-Log (Standard)

**Typ:** Report  
**Hauptprogramm:** `RSAU_SELECT_EVENTS`

**Zweck:** [Kurzbeschreibung basierend auf Analyse]

**Detaillierte Dokumentation:** [GUI-Mockup YAUDN](./../../../.github/prompts/3_DepthDocumentation/11_GUI_Prompts/YAUDN_Mockup.md)
...
Ã„ndere Status von â³ zu âœ… fÃ¼r YAUDN.
