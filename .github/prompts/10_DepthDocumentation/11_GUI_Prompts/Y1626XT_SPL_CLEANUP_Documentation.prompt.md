# GUI-Dokumentation: Y1626XT_SPL_CLEANUP - Xiting Times Spool Wiederherstellung

**Transaktion:** Y1626XT_SPL_CLEANUP  
**Programm:** /XITING/XT_LOG_SPOOL_CLEANUP  
**Komponente:** ADM 4.0 Integration (adm_40)  
...
Erstelle eine vollstÃ¤ndige GUI-Dokumentation fÃ¼r die Transaktion **Y1626XT_SPL_CLEANUP** mit detaillierten UI-Mockups, Funktionsbeschreibungen und Ablaufdiagrammen.
...
â”‚ Y1626XT_SPL_CLEANUP - Xiting Times Spool Wiederherstellung                                         âŠ  â–¡ Ã—  â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
...
```mermaid
flowchart TD
    Start([Start Y1626XT_SPL_CLEANUP]) --> Selection[Screen anzeigen]
...
FÃ¼ge Verlinkung in `#file:../../../../docs/03_ComponentDocumentation/3.01_ADM40Documentation.md` ein:

ErgÃ¤nze im Abschnitt "GUI-Transaktionen":

```markdown
#### Y1626XT_SPL_CLEANUP - Xiting Times Spool Wiederherstellung

**Typ:** Report (SAP Standard)  
**Hauptprogramm:** `/XITING/XT_LOG_SPOOL_CLEANUP`

**Zweck:** [Kurzbeschreibung basierend auf Analyse]

**Detaillierte Dokumentation:** [GUI-Mockup Y1626XT_SPL_CLEANUP](./../../../.github/prompts/3_DepthDocumentation/11_GUI_Prompts/Y1626XT_SPL_CLEANUP_Mockup.md)
...
Ã„ndere Status von â³ zu âœ… fÃ¼r Y1626XT_SPL_CLEANUP.
