"""
Plot I_se vs I_P (linear relation) from Linear_80_2025.csv.
Output: plot_linear_80_relation.png
"""
import pathlib
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
from style import RC, C_PE, C_SE as C_EBIC, FACECOLOR

HERE = pathlib.Path(__file__).parent
plt.rcParams.update(RC)

df = pd.read_csv(HERE / "Linear_80_2025.csv")
...
ax.set_title("80 kV,  32 nA — linear regime", fontweight="bold")
...
fig.tight_layout()
fig.savefig(HERE / "plot_linear_80_relation.png")
plt.close(fig)
print("Saved plot_linear_80_relation.png")
